...
import { Divider, List, ListItem, ListItemText, Paper, Table, TableBody, TableCell, TableContainer, TableHead, TableRow } from '@mui/material'
...
const CardWeather = ({ weather, forecast, city }) => {
  ...
  return (
    <div className="mt-20">
      <div className="flex max-w-6xl h-[800px] bg-primary">
        <aside
          className="
            relative
            w-3/12 h-full
